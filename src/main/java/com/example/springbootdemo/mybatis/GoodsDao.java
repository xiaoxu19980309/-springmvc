...
public interface GoodsDao {
    ...
    @Select("<script>select id,goods_name,goods_price,goods_num,main_pic,sub_pic,description,type_id,is_special,is_delete," +
    ...
    @Select("<script>select goods.id,goods_name,goods_price,goods_num,main_pic,sub_pic,description,goods.type_id,goods.is_special,goods.is_delete,goods_type.type_name as typeName," +
